...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-07-2025 a las 18:23:34
...
(58, '1197767', 'Alexis Santiago Pérez', 'Desarrollo de sistemas', 'J.U.D. de Soporte Técnico', 'av moneda s/numero', '5548857306', '2025-07-08 16:49:14', '2025-07-10 22:15:24'),
...
--
ALTER TABLE `documentos`
  ADD CONSTRAINT `fk_empleado` FOREIGN KEY (`numero_empleado`) REFERENCES `catalogo_personal` (`numero_empleado`);
